    ...
    <Paper className={classes.formPaper}>
      ...
      >
        ...
        <TextField
          ...
          error={handleError && pollData.subject === ""}
          helperText={handleError && pollData.subject === "" ? "Mandatory" : ""}
          onChange={(e) =>
            setPollData({ ...pollData, subject: e.target.value })
          }
        />
        ...
        <FormControl fullWidth error={handleError && optionCounter < 2}>
          <TextField
            ...
            onChange={(e) =>
              setChoice1Data({ ...choice1Data, text: e.target.value })
            }
          />
          <TextField
            variant="outlined"
            ...
            onChange={(e) =>
              setChoice2Data({ ...choice2Data, text: e.target.value })
            }
          />
          {addCounter >= 1 && (
            <TextField
              ...
              onChange={(e) =>
                setChoice3Data({ ...choice3Data, text: e.target.value })
              }
            />
          )}
          {addCounter >= 2 && (
            <TextField
              ...
              onChange={(e) =>
                setChoice4Data({ ...choice4Data, text: e.target.value })
              }
            />
          )}

          {handleError && optionCounter < 2 && (
            <FormHelperText>Required minimum 2 options</FormHelperText>
          )}
        </FormControl>
